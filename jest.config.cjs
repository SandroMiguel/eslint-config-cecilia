...
module.exports = {
  ...
  // An object that configures minimum threshold enforcement for
  // coverage results
  ...
  // Force coverage collection from ignored files using an array of
  // glob patterns
  // forceCoverageMatch: [],
  ...
  // A set of global variables that need to be available in all
  // test environments
  // globals: {},
