...
SVC_NAME="actions.runner.SandroMiguel-eslint-config-cecilia.eslint-config-cecilia-.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (SandroMiguel-eslint-config-cecilia.eslint-config-cecilia-runner)"
